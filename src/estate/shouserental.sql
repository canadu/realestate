...
CREATE TABLE `room_rental_registrations` (
  ...
  `fullname` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `mobile` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `alternat_mobile` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `landmark` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `rent` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `sale` varchar(190) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `deposit` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `plot_number` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `rooms` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `address` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `accommodation` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `description` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `image` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `open_for_sharing` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `other` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `room_rental_registrations_apartment` (
  ...
  `deposit` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `plot_number` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  `apartment_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ap_number_of_plats` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `rooms` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `floor` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `purpose` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `own` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
